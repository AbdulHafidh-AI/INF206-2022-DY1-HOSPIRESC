                 ...
                 <ul class="navbar-nav ms-auto">
                     <li class="nav-item">
                         <a class="nav-link active" href="about"> <span
                                 class="{{ ($title == 'Tentang Kami' && $status == 'login') ? 'blue' : '' }}"> TENTANG <br> KAMI </span> </a>
                     </li>
                     <li class="nav-item">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" style="background-color: #2F303A" aria-labelledby="navbarDropdown">
                            <div class="text-center">
                                ...
                                <li><a class="dropdown-item fiturProfile" href="profile"> <span class="{{ $title == 'Profile' ? 'blue' : '' }}"> PROFILE </span> </a></li>
